...
export default function HeroComponent() {
  ...
  const handleEmail = () => {
    window.location.href = "mailto:richiechristiandeguzman11@gmail.com"
  }
      ...
      <div className="w-full max-w-6xl flex flex-col gap-10">
        <div className="flex flex-col gap-4">
          ...
          <h1
            ...
            className="font-[var(--font-roboto-flex)] text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-black max-w-4xl mt-2"
          >
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl leading-relaxed mt-4">
        ...
        <div className="flex flex-wrap gap-4 mt-4">
          <button
            onClick={handleEmail}
            className="group border border-black rounded-2xl px-6 py-3 h-12 flex items-center gap-2 text-black transition-all duration-300 hover:bg-black hover:text-white hover:-translate-y-1 active:translate-y-0"
          >
            Let&apos;s Talk
